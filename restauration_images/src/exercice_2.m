...
figure('Name','Tracez le domaine D');
imagesc(max(0,min(1,u_0/u_max)),[0 1]);
if nb_canaux==1; colormap gray; end
axis image off
title({'Dessinez la zone D a restaurer','Double-clic pour terminer'},'FontSize',16);

D = logical(imread('Images/defaut_fleur.png'));

...
alpha = 0.004;				% Poids de la penalisation de la longueur
beta = 0.002;				% Poids de la penalisation de la courbure

% Parametre de la descente de gradient :
gamma = 0.2;				% Pas de la descente de gradient
nb_iterations_max = 100000;		% Nombre d'iterations maximal
